...
class CourseCustomListRVAdapter(private val customList: ArrayList<SimpleCourse>): RecyclerView.Adapter<CourseCustomListRVAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, viewType: Int): CourseCustomListRVAdapter.ViewHolder {
